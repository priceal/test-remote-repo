...
#
# contains functions for analyzing video data from BLAs
# functions can detect peaks and allow user to examine
# in various ways
#
#
#################################################
...
#        _,imax,_,xymax = cv.minMaxLoc(frame)
    ...
    return np.array(listxy)[:-1], np.array(listvalue)[:-1], framestats
